...
import { setSelectedGiftId } from '../../../store/cartSlice';
...
const GiftSelection: React.FC<GiftSelectionProps> = ({ gifts }) => {
  const dispatch = useAppDispatch();
  const selectedGiftId = useAppSelector((state: RootState) => state.cart.selectedGiftId);
  console.log("selectedGiftId", selectedGiftId);
